...
import torch
from logger import *
from utils.datacollection.Operation import add_unary, operation_set, O1, O3, O2, sep_token
...
def init_param():
    ...
    parser.add_argument('--file-name', type=str, default='ap_omentum_ovary',
                        help='data name')
    ...
    parser.add_argument('--enlarge_num', type=int, default=3, help=
